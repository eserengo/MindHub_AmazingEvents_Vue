...
const App = createApp({
  ...
  template: `
          ...
          <div class="col-2 col-sm-8 col-lg-6">
            ...
            <div class="collapse navbar-collapse w-100 justify-content-sm-end" id="navbar">
              <ul
                ...
                <li class="nav-item">
                  <a href="./contact.html" aria-current="page" class="nav-link active fs-6"
                    style="color: rgb(214, 0, 100);">Contact</a>
                </li>
                <li class="nav-item">
    ...
    <section id="carousel" class="carousel slide position-relative">
      ...
      <h1 class="position-absolute top-50 start-50 translate-middle text-white" style="font-size: 64px;">Contact</h1>
    </section>
  </header>

  <main>
    <form action="#" class="border border-dark-subtle rounded shadow-sm mx-2 mx-md-5">
      <div class="container-fluid py-2 px-4">
        <div class="row w-100 mb-3">
          <div class="col">
            <label for="name" class="form-label">Name:</label>
            <input type="email" class="form-control shadow-sm bg-body-tertiary" id="name" autocomplete="off"
        ...
        <div class="row w-100 mb-3">
          <div class="col">
            ...
            <input type="email" class="form-control shadow-sm bg-body-tertiary" id="email" autocomplete="off"
              spellcheck="false" required>
          </div>
        </div>
        <div class="row w-100 mb-3">
          <div class="col">
            ...
            <textarea class="form-control shadow-sm bg-body-tertiary" id="textarea" rows="5" autocomplete="off"
              spellcheck="false" required></textarea>
          </div>
        </div>
        <div class="row w-100 d-flex justify-content-end">
          <div class="col-4 me-2 col-sm-2 me-sm-3 col-md-1 me-md-4">
