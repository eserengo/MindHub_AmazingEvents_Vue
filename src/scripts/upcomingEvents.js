...
const App = createApp({
          ...
          <div class="col-2 col-sm-8 col-lg-6">
            ...
            <div class="collapse navbar-collapse w-100 justify-content-sm-end" id="navbar">
              <ul
                ...
                <li class="nav-item">
                  <a href="./upcomingEvents.html" aria-current="page" class="nav-link active fs-6"
                    style="color: rgb(214, 0, 100);">Upcoming Events</a>
                </li>
                <li class="nav-item">
  ...
  <main>
    <nav class="navbar d-none" id="upcomingEventsNavBar">
      <div class="container-fluid">
        <div class="row w-100 d-flex flex-row align-items-center justify-content-between">
          <div class="col-6 col-md-8">
            ...
            <form class="d-flex flex-column flex-sm-row flex-wrap align-items-sm-start align-items-sm-center gap-1 gap-sm-3"
              action="#">
              <fieldset id="upcomingEventsCategoriesContainer">
    ...
    <div class="container-fluid p-2">
      ...
      <div class="row w-100" id="upcomingEventsCardsContainer"></div>
